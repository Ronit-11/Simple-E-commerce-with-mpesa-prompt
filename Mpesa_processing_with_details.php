...
if($_SESSION['total']>0){
    $consumer_key = 'J28yBLjFTOPUlitr6EAO4d24oEKTkCGL'; //get these details from daraja api
    $consumer_secret = 'vkR3HxGboMeQxCQQ';              //get these details from daraja api
    $Business_Code = '174379';                          //get these details from daraja api
    $Passkey = 'bfb279f9aa9bdbcf158e97dd71a467cd2e0c893059b10f78e6b72ada1ed2c919';  //get these details from daraja api
    $Type_of_Transaction = 'CustomerPayBillOnline';
    $Token_URL = 'https://sandbox.safaricom.co.ke/oauth/v1/generate?grant_type=client_credentials';
    $phone_number = '254707093963';       // phone number of the buyer(to be sent mpesa stk push) with country code ie 254xxxxxxxxx
    $OnlinePayment = 'https://sandbox.safaricom.co.ke/mpesa/stkpush/v1/processrequest';
    $total_amount = '1';   //amount to be charged
    $CallBackURL = 'https://534f-41-81-73-100.in.ngrok.io/E-commerce%20site/Logged%20In%20Home%20page.php';   //redirect url after mpesa prompt is sent
